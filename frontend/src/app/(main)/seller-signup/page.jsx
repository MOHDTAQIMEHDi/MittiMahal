...
import * as Yup from 'yup'; //import the Yup library for form validation

// Signup schema for form validation using Yup library 
...
const Signup = () => {
  ...
  //initialising the formik //useFormik hook to create a form 
  const signupForm = useFormik({
    ...
    onSubmit:(value,{resetForm ,setSubmitting})=>{
      ...
      axios.post('http://localhost:5000/seller/add', value)
      .then((result) => {
  ...
  <div className="p-4 sm:p-7">
    <div className="text-center">
      <h1 className="block text-2xl font-bold text-[#854d27] dark:text-white">
       Seller Sign up
      </h1>
      <p className="mt-2 text-sm text-gray-600 dark:text-neutral-400">
        Already have an account?
        <a
          className="text-[#854d27] hover:text-[#6e3b1e] focus:outline-none focus:underline font-medium dark:text-blue-500"
          href="/seller-login"
        >
          Log in here
        </a>
      ...
      <form onSubmit={signupForm.handleSubmit}>
        <div className="grid gap-y-4">
          ...
          <div>
            ...
            {
             ( signupForm.touched.mobile && signupForm.errors.mobile) && 
             (
              <p className=" text-xs text-red-600 mt-2" id="email-error">
          ...
          <div>
            ...
            {
             ( signupForm.touched.state && signupForm.errors.state) && 
             (
              <p className=" text-xs text-red-600 mt-2" id="email-error">
          ...
          <div>
            ...
            {
             ( signupForm.touched.pincode && signupForm.errors.pincode) && 
             (
              <p className=" text-xs text-red-600 mt-2" id="email-error">
              {signupForm.errors.pincode}
            </p>
             )
            }
          ...
          <div className="flex items-center">
            ...
            <div className="ms-3">
              <label htmlFor="remember-me" className="text-sm dark:text-white">
                I accept the{" "}
                <a
                  className="text-[#854d27] decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                  href="#"
                >
          ...
          <button
            ...
            type="submit"
            className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#854d27] text-white hover:bg-[#6e3b1e]  focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
          >  {
