'use client'
import { ChevronDown, Facebook, Heart, Instagram, Link, Mail, Menu, Phone, Search, ShoppingBag, Twitter, User } from 'lucide-react'
...
function Navbar() {
  ...
  //                         <img src="/placeholder.svg?height=20&width=20" alt="Home Decor" width={20} height={20} />
  //                       </span>
  //                       Home Decor
  //                     </Link>
  //                     <Link
  ...
  //                     >
  //                       <span className="w-8 h-8 rounded-full bg-[#F5EFE7] flex items-center justify-center mr-3">
  //                         <img src="/placeholder.svg?height=20&width=20" alt="Kitchen" width={20} height={20} />
  //                       </span>
  //                       Kitchen & Dining
  //                     </Link>
  //                     <Link
  ...
  //                     >
  //                       <span className="w-8 h-8 rounded-full bg-[#F5EFE7] flex items-center justify-center mr-3">
  //                         <img src="/placeholder.svg?height=20&width=20" alt="Garden" width={20} height={20} />
  //                       </span>
  //                       Garden Pottery
  //                     </Link>
  //                     <Link
  ...
  //                     >
  //                       <span className="w-8 h-8 rounded-full bg-[#F5EFE7] flex items-center justify-center mr-3">
  //                         <img src="/placeholder.svg?height=20&width=20" alt="Sculptures" width={20} height={20} />
  //                       </span>
  //                       Artistic Sculptures
  //                     </Link>
  //                     <Link
  ...
  //                     >
  //                       <span className="w-8 h-8 rounded-full bg-[#F5EFE7] flex items-center justify-center mr-3">
  //                         <img src="/placeholder.svg?height=20&width=20" alt="Traditional" width={20} height={20} />
  //                       </span>
  //                       Traditional Pottery
  //                     </Link>
  //                   </div>
  ...
  //                     <img src="/placeholder.svg?height=16&width=16" alt="Home Decor" width={16} height={16} />
  //                   </span>
  //                   Home Decor
  //                 </Link>
  //                 <Link
