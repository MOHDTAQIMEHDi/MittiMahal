...
export const colors = [
  { name: "Natural Clay", value: "#c8652d" },
  { name: "Terracotta Red", value: "#9e2b0e" },
  { name: "Earth Brown", value: "#5e3023" },
  { name: "Ceramic White", value: "#f5f5f5" },
  { name: "Black Clay", value: "#2d2d2d" },
  { name: "Blue Pottery", value: "#146b9c" }
];